<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-50">
        ...
        <div class="fixed inset-0 overflow-hidden z-0">
            ...
            <div class="absolute bottom-1/4 left-1/3 w-24 h-24 bg-orange-100 rounded-full opacity-25 animate-float3">
            </div>
            <div class="absolute bottom-1/3 right-1/3 w-12 h-12 bg-orange-200 rounded-full opacity-30 animate-float4">
            </div>
        </div>

        <div
            class="w-full sm:max-w-2xl mt-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg relative z-10 transform transition-all duration-500 ease-in-out hover:shadow-xl">
            <!-- Logo dengan animasi bounce -->
            <div class="flex justify-center mb-6 animate-bounce">
                <a href="{{ route('home') }}" class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-8 w-8 text-orange-500 group-hover:text-orange-600 transition-all duration-300 transform group-hover:rotate-12"
                        viewBox="0 0 24 24" fill="currentColor">
                        <!-- Utensil Set Icon -->
                        <path
                            d="M8 1a2 2 0 0 1 2 2v2h4V3a2 2 0 1 1 4 0v2a3 3 0 0 1 3 3v1a3 3 0 0 1-3 3v7a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3v-7a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3V3a2 2 0 0 1 2-2z" />
                        <!-- Plate/Bowl -->
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="animate-fade-in-up" style="animation-delay: 0.1s">
                    ...
                    <input id="name"
                        class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out transform hover:scale-105"
                ...
                <div class="mt-4 animate-fade-in-up" style="animation-delay: 0.25s">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div
                            class="border border-gray-300 rounded-lg p-3 hover:border-orange-500 transition-colors duration-200">
                        ...
                        <div
                            class="border border-gray-300 rounded-lg p-3 hover:border-orange-500 transition-colors duration-200">
                            <div class="flex items-start">
                                <input id="role_pengusaha" name="role" type="radio" value="pengusaha"
                                    class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 mt-1"
                                    {{ old('role') == 'pengusaha' ? 'checked' : '' }} required>
                                <label for="role_pengusaha"
                                    class="ml-3 block text-sm font-medium text-gray-700 cursor-pointer">
                                    <div class="flex items-center mb-1">
                ...
                <div id="pengusaha-fields" class="space-y-4 mt-4" style="display: none;">
                    <div class="p-4 bg-orange-50 rounded-lg border border-orange-200">
                        ...
                        <!-- Nama Usaha -->
                        <div class="space-y-2">
                            <label for="title" class="block text-sm font-medium text-gray-700">Nama Usaha <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="title" id="title" value="{{ old('title') }}"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out">
                            @error('title')
                        ...
                        <div class="space-y-2 mt-4">
                            <label for="description" class="block text-sm font-medium text-gray-700">Deskripsi Usaha
                                <span class="text-red-500">*</span></label>
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out">{{ old('description') }}</textarea>
                            <p class="text-sm text-gray-500">Jelaskan tentang usaha kuliner Anda, menu spesial, jam
                                operasional, dll.</p>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <!-- Category -->
                        <div class="space-y-2 mt-4">
                            <label for="pengusaha_category" class="block text-sm font-medium text-gray-700">Kategori
                                <span class="text-red-500">*</span></label>
                            <select name="pengusaha_category" id="pengusaha_category"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out">
                                <option value="">Pilih Kategori</option>
                                @foreach ($foodCategories as $foodCategory)
                                    <option value="{{ $foodCategory->id }}"
                                        {{ old('pengusaha_category') == $foodCategory->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <!-- Min Price -->
                            <div class="space-y-2">
                                <label for="min_price" class="block text-sm font-medium text-gray-700">Harga Minimum
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="min_price" id="min_price"
                                        ...
                                        class="block w-full pl-12 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out">
                                </div>
                                @error('min_price')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <!-- Max Price -->
                            <div class="space-y-2">
                                <label for="max_price" class="block text-sm font-medium text-gray-700">Harga Maksimum
                                    (Rp) <span class="text-red-500">*</span></label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 sm:text-sm">Rp</span>
                        ...
                        <!-- Location -->
                        <div class="space-y-2 mt-4">
                            <label for="pengusaha_location" class="block text-sm font-medium text-gray-700">Alamat
                                Usaha <span class="text-red-500">*</span></label>
                            <input type="text" name="pengusaha_location" id="pengusaha_location"
                                value="{{ old('pengusaha_location') }}"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out">
                        ...
                        <!-- Google Maps Link -->
                        <div class="space-y-2 mt-4">
                            <label for="source_location" class="block text-sm font-medium text-gray-700">Link Google
                                Maps</label>
                            <input type="url" name="source_location" id="source_location"
                                value="{{ old('source_location') }}"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300 ease-in-out"
                                placeholder="https://maps.google.com/...">
                            <p class="text-sm text-gray-500">Tambahkan link Google Maps untuk lokasi usaha Anda
                                (opsional).</p>
                            ...
                            <div class="mt-1">
                                <label
                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        <span id="menu-file-name">Pilih Foto Menu (Maksimal 10 foto)</span>
                                    </div>
                                    <input type="file" name="menu_images[]" id="menu_images" multiple
                                        accept="image/*" class="hidden">
                                </label>
                            </div>
                            <div id="menu-image-preview" class="mt-2 grid grid-cols-2 md:grid-cols-3 gap-2">
                            </div>
                            <p class="text-sm text-gray-500">
                                Unggah foto menu makanan/minuman Anda (Max: 2MB per file, Format: JPG, PNG, maksimal 10
                                foto).
                            </p>
                            @error('menu_images')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div class="mt-6 animate-fade-in-up" style="animation-delay: 0.5s">
                    <button type="submit"
                        class="px-6 py-3 bg-orange-500 text-white font-medium rounded-lg hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-md w-full">
            ...
            <div class="mt-6 text-center animate-fade-in-up" style="animation-delay: 0.6s">
                <p class="text-sm text-gray-600">
                    Sudah punya akun?
                    <a href="{{ route('login') }}"
                        class="text-orange-500 hover:text-orange-700 font-medium transition duration-150 ease-in-out hover:underline">
                        Masuk Sekarang
                    </a>
                </p>
            </div>
            ...
            <div class="mt-6 animate-fade-in-up" style="animation-delay: 0.7s">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="#"
                        class="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition duration-300 ease-in-out transform hover:scale-105">
