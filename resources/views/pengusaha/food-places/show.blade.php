        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div
                ...
                <div class="p-8">
                    ...
                    <div
                        class="flex flex-col items-start justify-between mb-2 space-y-4 md:flex-row md:items-center md:space-y-0">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <span
                            class="px-4 py-2 text-sm font-medium text-black transition-all duration-300 transform bg-orange-500 rounded-full shadow-lg hover:scale-110 hover:bg-orange-600">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row">
                        <div class="bg-orange-500">
                            <a href="{{ $foodPlace->source_location }}" target="_blank"
                                class="flex items-center justify-center px-4 py-2 text-white transition-colors bg-red-500 rounded-lg hover:bg-orange-600">
    ...
    <div id="imageModal" class="fixed inset-0 z-50 items-center justify-center hidden bg-black bg-opacity-75"
        ...
        <div class="relative max-w-4xl max-h-[90vh] mx-4" onclick="event.stopPropagation()">
            ...
            <button onclick="closeImageModal()"
                class="absolute p-2 text-white transition-colors bg-black bg-opacity-50 rounded-full top-4 right-4 hover:text-gray-300">
