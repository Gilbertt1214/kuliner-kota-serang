...
@section('content')
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center min-h-[80vh]">
                <div class="md:w-[45%] mb-8 md:mb-0 pl-0 animate-fade-in-left">
                    <h1 class="text-4xl md:text-4xl font-bold mb-4 leading-tight">Temukan Kuliner Terbaik di Kota Serang</h1>
                    <p class="text-xl mb-6 opacity-90">Platform terpercaya untuk menemukan kuliner terbaik Kota Serang.
    ...
    <section class="py-8 bg-gray-50 relative z-10">
        <div class="container mx-auto px-4">
