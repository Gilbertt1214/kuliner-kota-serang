        ...
        <div class="container relative px-4 mx-auto">
            <div class="flex flex-col md:flex-row items-center min-h-[80vh]">
                <div class="md:w-[45%] mb-8 md:mb-0 pl-0 animate-fade-in-left">
                    ...
                    <h1
                        class="mb-4 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl bg-gradient-to-r from-white to-orange-100 bg-clip-text text-transparent">
                        Temukan Kuliner Terbaik di Kota Serang
                    </h1>
                    <p class="mb-8 text-xl opacity-90 leading-relaxed">Platform terpercaya untuk menemukan kuliner terbaik
                        Kota Serang.
    ...
    <section id="popular-section" class="py-16 bg-gradient-to-br from-orange-50 to-red-50">
        <div class="container px-4 mx-auto">
            <div class="text-center mb-12 animate-fade-in">
                ...
                <p class="max-w-2xl mx-auto text-gray-600 text-lg">Tempat makan dengan rating tertinggi dan ulasan terbaik
                    dari para food lover di Serang</p>
            </div>

            @php
                // Sort featured places by rating (highest first)
                $popularPlaces = $featuredPlaces
                    ...
                    <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-fade-in-up"
                        ...
                        @if ($index < 3)
                            <div class="absolute top-4 left-4 z-20">
                                <div
                                    class="flex items-center justify-center w-12 h-12 rounded-full font-bold text-white text-lg
                        ...
                        <div class="relative overflow-hidden h-64">
                            @if ($foodPlace->images->count() > 0)
                                <img src="{{ $foodPlace->images->first()->image_url }}" alt="{{ $foodPlace->title }}"
                                    class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-110">
                            @else
                                <div
                                    class="flex items-center justify-center w-full h-full bg-gradient-to-br from-gray-200 to-gray-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <span
                                    class="px-3 py-1 text-xs font-medium text-orange-600 bg-orange-100 rounded-full border border-orange-200">
                            ...
                            <!-- Title -->
                            <h3
                                class="text-xl font-bold text-gray-800 mb-2 group-hover:text-orange-600 transition-colors duration-300">
                                {{ $foodPlace->title }}
                            </h3>

                            <!-- Description -->
                            <p class="text-gray-600 text-sm mb-4 line-clamp-2 leading-relaxed">
                                {{ $foodPlace->description }}</p>
                                ...
                                <div>
                                    ...
                                    @if ($foodPlace->max_price > $foodPlace->min_price)
                                        <span class="text-gray-400"> -
                                            {{ number_format($foodPlace->max_price, 0, '', '.') }}</span>
                                    @endif
                                </div>
                    ...
                    @foreach ($featuredPlaces->take(3) as $index => $foodPlace)
                        <div class="overflow-hidden transition-all duration-500 delay-100 transform bg-white shadow-lg group rounded-2xl hover:shadow-xl hover:-translate-y-2 animate-fade-in-up border border-gray-100"
                            ...
                            <div class="relative overflow-hidden h-60">
                                ...
                                @endphp
                                <div
                                    class="absolute flex items-center px-3 py-1 text-yellow-600 rounded-full shadow-md top-3 right-3 bg-white/90 backdrop-blur-sm">
                                ...
                                <div class="absolute top-3 left-3">
                                    <span
                                        class="px-2 py-1 text-xs font-bold text-white bg-green-500 rounded-full animate-pulse">NEW</span>
                                </div>
                            </div>
                            <div class="p-6">
                                ...
                                <h3
                                    class="mb-2 text-xl font-bold text-gray-800 group-hover:text-orange-600 transition-colors duration-300">
                                    {{ $foodPlace->title }}</h3>
                                <p class="mb-4 text-gray-600 line-clamp-2">{{ $foodPlace->description }}</p>
                                <div class="flex items-center justify-between">
                                    <span class="font-bold text-orange-600 text-lg">Rp
    ...
    <section class="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="container px-4 mx-auto">
            <div class="mb-12 text-center animate-fade-in">
                ...
                <p class="max-w-2xl mx-auto text-gray-600 text-lg">Jelajahi berbagai kategori kuliner di kota Serang yang
                    menawarkan cita rasa autentik dan pengalaman kuliner tak terlupakan.</p>
            </div>
                ...
                @foreach ($categories as $index => $category)
                    <div class="overflow-hidden transition-all duration-500 transform bg-white shadow-lg group rounded-2xl hover:-translate-y-3 hover:shadow-2xl animate-fade-in-up border border-gray-100"
                        ...
                        <div class="p-6 text-center">
                            <div
                                class="flex items-center justify-center w-16 h-16 mx-auto mb-4 transition-all duration-300 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 group-hover:scale-110 group-hover:rotate-6 shadow-lg">
