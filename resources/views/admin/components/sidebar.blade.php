<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ route('admin.dashboard') }}">
            <img src="/assets/place-icon.svg"
                class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">SANTARA</span>
        </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <!-- Dashboard -->
            {{-- <x-admin.sidebar-item :active="request()->routeIs('admin.dashboard')" :href="route('admin.dashboard')"
                icon='
            ...
            <!-- Food Place -->
            <x-admin.sidebar-item :active="request()->routeIs('admin.food-places.*')" :href="route('admin.food-places.index')"
                icon='
                                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>office</title>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-1869.000000, -293.000000)" fill="#1e293b" fill-rule="nonzero">
                                            <g transform="translate(1716.000000, 291.000000)">
            ...
            <!-- Category -->
            <x-admin.sidebar-item :active="request()->routeIs('admin.categories.*')" :href="route('admin.categories.index')"
                icon='
            ...
            <!-- User -->
            <x-admin.sidebar-item :active="request()->routeIs('admin.users.*')" :href="route('admin.users.index')"
                icon='
